...
https://petaos.tech/im/home/conversation；使用当前授权会话，或官网 Console → PETAOS Apps → Enterprise Messenger。

## 前置条件

插件版先读 [使用边界与验证状态](../petaos-start/references/使用边界与验证状态.md)，了解授权范围及历史报错的较新复核结果；具体页面以当前会话为准。

已登录正确企业，具备通讯访问权限；明确对话对象。
...
4. Enterprise Messenger 是独立会话布局，可能没有 PETAOS Apps 切换器。不能凭“空会话”推断消息丢失。
...
证据版本：2026-09-14；当前可见 1 个菜单/工作台入口，生产业务未提交验证。
